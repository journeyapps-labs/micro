...
> = T extends t.TransformTarget.Encoded
  ? defs.MicroValidator<t.Encoded<C>>
  : defs.MicroValidator<t.Decoded<C>>;

type ValidatorOptions<T extends t.TransformTarget> = Partial<
  Omit<t.BaseParserParams, "target">
> & {
  target?: T;
};
 ...
 */
export const createTsCodecValidator = <
  C extends t.AnyCodec,
  T extends t.TransformTarget = t.TransformTarget.Encoded,
>(
  codec: C,
